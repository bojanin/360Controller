...
Feedback360Effect::Feedback360Effect(FFEffectDownloadID theHand)
    : Feedback360Effect() {
  Handle = theHand;
}
...
// CalcEnvelope
//----------------------------------------------------------------------------------------------
void Feedback360Effect::CalcEnvelope(ULONG Duration, ULONG CurrentPos,
...
void Feedback360Effect::CalcForce(ULONG Duration, ULONG CurrentPos,
                                  LONG NormalRate, LONG AttackLevel,
