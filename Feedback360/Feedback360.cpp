...
static IOCFPlugInInterface functionMap360_IOCFPlugInInterface = {
    ...
    NULL,
    // IUnknown
    &Feedback360::sQueryInterface, &Feedback360::sAddRef,
    &Feedback360::sRelease,
    // IOCFPlugInInterface
    1, 0,  // Version
    &Feedback360::sProbe, &Feedback360::sStart, &Feedback360::sStop};

static IOForceFeedbackDeviceInterface
    functionMap360_IOForceFeedbackDeviceInterface = {
        // Padding required for COM
        NULL,
        // IUnknown
        &Feedback360::sQueryInterface, &Feedback360::sAddRef,
        ...
        &Feedback360::sDestroyEffect, &Feedback360::sDownloadEffect,
        &Feedback360::sEscape, &Feedback360::sGetEffectStatus,
        &Feedback360::sGetForceFeedbackCapabilities,
        &Feedback360::sGetForceFeedbackState,
        &Feedback360::sSendForceFeedbackCommand, &Feedback360::sSetProperty,
        &Feedback360::sStartEffect, &Feedback360::sStopEffect};
...
Feedback360::Feedback360()
  ...
  iIOCFPlugInInterface.pseudoVTable =
      (IUnknownVTbl *)&functionMap360_IOCFPlugInInterface;
...
ULONG Feedback360::AddRef() { return ++fRefCount; }
...
IOReturn Feedback360::Probe(CFDictionaryRef propertyTable, io_service_t service,
                            SInt32 *order) {
  if ((service == 0) ||
...
IOReturn Feedback360::Start(CFDictionaryRef propertyTable,
                            io_service_t service) {
  return FF_OK;
}

IOReturn Feedback360::Stop(void) { return FF_OK; }
...
HRESULT Feedback360::StartEffect(FFEffectDownloadID EffectHandle,
                                 FFEffectStartFlag Mode, UInt32 Count) {
  dispatch_sync(Queue, ^{
    for (Feedback360EffectIterator effectIterator = EffectList.begin();
...
HRESULT Feedback360::DownloadEffect(CFUUIDRef EffectType,
...
HRESULT Feedback360::GetForceFeedbackState(
...
HRESULT Feedback360::GetForceFeedbackCapabilities(
...
HRESULT Feedback360::InitializeTerminate(NumVersion APIversion,
...
HRESULT Feedback360::Escape(FFEffectDownloadID downloadID,
                            FFEFFESCAPE *escape) {
...
void Feedback360::SetForce(LONG LeftLevel, LONG RightLevel) {
  ...
  unsigned char buf[] = {
      0x00, 0x04, (unsigned char)min(SCALE_MAX, LeftLevel * (LONG)Gain / 10000),
...
void Feedback360::EffectProc(void *params) {
  ...
  if (cThis->Actuator == true) {
    for (Feedback360EffectIterator effectIterator = cThis->EffectList.begin();
...
HRESULT Feedback360::GetEffectStatus(FFEffectDownloadID EffectHandle,
...
IOReturn Feedback360::sProbe(void *self, CFDictionaryRef propertyTable,
                             io_service_t service, SInt32 *order) {
  return getThis(self)->Probe(propertyTable, service, order);
}

IOReturn Feedback360::sStart(void *self, CFDictionaryRef propertyTable,
                             io_service_t service) {
  return getThis(self)->Start(propertyTable, service);
}

IOReturn Feedback360::sStop(void *self) { return getThis(self)->Stop(); }

HRESULT Feedback360::sGetVersion(void *self, ForceFeedbackVersion *version) {
  return Feedback360::getThis(self)->GetVersion(version);
}

HRESULT Feedback360::sInitializeTerminate(void *self,
                                          NumVersion forceFeedbackAPIVersion,
                                          io_object_t hidDevice,
                                          boolean_t begin) {
  return Feedback360::getThis(self)->InitializeTerminate(
...
HRESULT Feedback360::sDownloadEffect(void *self, CFUUIDRef effectType,
                                     FFEffectDownloadID *pDownloadID,
                                     FFEFFECT *pEffect,
                                     FFEffectParameterFlag flags) {
  return Feedback360::getThis(self)->DownloadEffect(effectType, pDownloadID,
                                                    pEffect, flags);
}

HRESULT Feedback360::sEscape(void *self, FFEffectDownloadID downloadID,
                             FFEFFESCAPE *pEscape) {
  return Feedback360::getThis(self)->Escape(downloadID, pEscape);
}

HRESULT Feedback360::sGetEffectStatus(void *self, FFEffectDownloadID downloadID,
                                      FFEffectStatusFlag *pStatusCode) {
  return Feedback360::getThis(self)->GetEffectStatus(downloadID, pStatusCode);
}

HRESULT Feedback360::sGetForceFeedbackState(
    void *self, ForceFeedbackDeviceState *pDeviceState) {
  return Feedback360::getThis(self)->GetForceFeedbackState(pDeviceState);
}

HRESULT Feedback360::sGetForceFeedbackCapabilities(
    void *self, FFCAPABILITIES *capabilities) {
  return Feedback360::getThis(self)->GetForceFeedbackCapabilities(capabilities);
}

HRESULT Feedback360::sSendForceFeedbackCommand(void *self,
                                               FFCommandFlag state) {
  return Feedback360::getThis(self)->SendForceFeedbackCommand(state);
}

HRESULT Feedback360::sSetProperty(void *self, FFProperty property,
                                  void *pValue) {
  return Feedback360::getThis(self)->SetProperty(property, pValue);
}

HRESULT Feedback360::sStartEffect(void *self, FFEffectDownloadID downloadID,
